...
class _$_Group implements _Group {
  ...
  @override
  String toString() {
    return 'Group(id: $id, teacherId: $teacherId, subjectId: $subjectId, languageId: $languageId, name: $name, description: $description, startDate: $startDate, dueDate: $dueDate, endDate: $endDate, passcode: $passcode)';
  }
...
abstract class _Group implements Group {
  const factory _Group(
      ...
      final String dueDate,
      final String endDate,
      final String passcode}) = _$_Group;
