...
abstract class $UserCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(6) String secondPhoneNumber,
      @HiveField(7) String birthDate,
      @HiveField(8) String country,
      @HiveField(9) String city,
    ...
    return _then(_value.copyWith(
      ...
      phoneNumber: phoneNumber == freezed
          ...
          : phoneNumber // ignore: cast_nullable_to_non_nullable
              as String,
      secondPhoneNumber: secondPhoneNumber == freezed
...
class _$_User implements _User {
  const _$_User(
      ...
      @HiveField(6) this.secondPhoneNumber = '',
      @HiveField(7) this.birthDate = '',
      @HiveField(8) this.country = '',
      @HiveField(9) this.city = '',
      @HiveField(10) this.ipAddress = ''});
  ...
  @override
  String toString() {
    return 'User(firstName: $firstName, lastName: $lastName, username: $username, email: $email, phoneNumber: $phoneNumber, secondPhoneNumber: $secondPhoneNumber, birthDate: $birthDate, country: $country, city: $city, ipAddress: $ipAddress)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.secondPhoneNumber, secondPhoneNumber) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(secondPhoneNumber),
...
abstract class _User implements User {
  const factory _User(
      ...
      @HiveField(6) final String secondPhoneNumber,
      @HiveField(7) final String birthDate,
      @HiveField(8) final String country,
      @HiveField(9) final String city,
      @HiveField(10) final String? ipAddress}) = _$_User;
